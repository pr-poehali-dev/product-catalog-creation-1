...
const categories = [
  ...
  { id: 'chebureki', name: 'Чебуреки', icon: 'Pizza' },
  { id: 'syrniki', name: 'Сырники', icon: 'Cake' },
...
const products: Product[] = [
  ...
  { id: 210, name: 'Сырники', category: 'syrniki', price: 450, composition: '', image: 'https://cdn.poehali.dev/files/de276f54-f1d6-4690-93d9-5d2294effcaf.JPG' },
