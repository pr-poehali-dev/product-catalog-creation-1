...
const categories = [
  ...
  { id: 'meatcutlets', name: 'Котлеты и п/фабрикаты из мяса', icon: 'ChefHat' },
...
const products: Product[] = [
  ...
  { id: 301, name: 'Бифштекс рубленный', category: 'meatcutlets', price: 650, composition: '', image: 'https://cdn.poehali.dev/files/f39323de-d378-4631-b1cd-bc5e0b68a136.JPG' },
  { id: 302, name: 'Биточки Неженка', category: 'meatcutlets', price: 580, composition: '', image: 'https://cdn.poehali.dev/files/42a0d1a7-7dec-423c-a2ff-c31b4bde2fd8.JPG' },
  { id: 303, name: 'Голубцы домашние', category: 'meatcutlets', price: 620, composition: '', image: 'https://cdn.poehali.dev/files/2414927f-9d98-4dec-8e08-99a5422b48a0.JPG' },
  { id: 304, name: 'Голубцы ленивые', category: 'meatcutlets', price: 590, composition: '', image: 'https://cdn.poehali.dev/files/1122cfce-7aaf-4334-8b6e-ffbfaa3d91c7.jpg' },
  { id: 305, name: 'Ёжики мясные', category: 'meatcutlets', price: 560, composition: '', image: 'https://cdn.poehali.dev/files/5c699b52-9646-44b4-9cc7-7ce198da630d.JPG' },
  { id: 306, name: 'Зразы мясные с грибами', category: 'meatcutlets', price: 680, composition: '', image: 'https://cdn.poehali.dev/files/f097b98f-9662-4100-94f9-4009584caeae.JPG' },
  { id: 307, name: 'Котлеты домашние', category: 'meatcutlets', price: 630, composition: '', image: 'https://cdn.poehali.dev/files/76f3b8cd-ddd7-41ef-a5c7-fa4a43c317bf.JPG' },
  { id: 308, name: 'Котлеты Забава', category: 'meatcutlets', price: 620, composition: '', image: 'https://cdn.poehali.dev/files/0985ea26-c530-4e57-a303-f6c30dd1152c.JPG' },
  { id: 309, name: 'Котлеты особые', category: 'meatcutlets', price: 640, composition: '', image: 'https://cdn.poehali.dev/files/072db856-c8c0-4f06-bcd7-6bd8d3f08bcb.JPG' },
  { id: 310, name: 'Котлеты Полтавские', category: 'meatcutlets', price: 660, composition: '', image: 'https://cdn.poehali.dev/files/5fcfd0e4-4088-41ff-89c1-af2903236276.JPG' },
  { id: 311, name: 'Котлеты свиные', category: 'meatcutlets', price: 670, composition: '', image: 'https://cdn.poehali.dev/files/7d7c067d-3224-4ac4-ac79-596410478dd6.JPG' },
  { id: 312, name: 'Перец фаршированный мясом', category: 'meatcutlets', price: 720, composition: '', image: 'https://cdn.poehali.dev/files/1cf79414-ea7c-42b9-aa61-71b2aac9abf2.JPG' },
  { id: 313, name: 'Тефтели', category: 'meatcutlets', price: 600, composition: '', image: 'https://cdn.poehali.dev/files/9f0b9e98-c634-4b25-9330-b2a636b6f7ed.JPG' },
  { id: 314, name: 'Фрикадельки', category: 'meatcutlets', price: 580, composition: '', image: 'https://cdn.poehali.dev/files/73381680-1afa-418d-86c0-bef19a927e3c.JPG' },
  { id: 315, name: 'Шницель свиной', category: 'meatcutlets', price: 690, composition: '', image: 'https://cdn.poehali.dev/files/6149870a-d696-4ee9-9abc-426c8b9acc20.JPG' },
