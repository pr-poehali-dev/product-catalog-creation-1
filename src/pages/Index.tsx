...
const products: Product[] = [
  ...
  { id: 31, name: 'Варёная русская ЭКО', category: 'sausages', price: 950, composition: 'Состав: говядина 50%, свинина 25%, шпик 25%, соль поваренная, сахар-песок, натуральные вкусо-ароматические добавки, краситель натуральный (фруктовые и овощные концентраты), специи. ГОСТ Р 52196-2011. Пищевая ценность (100г): белки 10г, жиры не более 30г. Калорийность 310 ккал. Срок годности при температуре от 0 до +6°C и относительной влажности воздуха 30 суток', image: 'https://cdn.poehali.dev/files/259add01-0a54-4aff-8e76-859d0ac5aa2e.JPG' },
